const projectsData = [
  {
    ...
    github_link: "https://github.com/iqnasf/Sistem-Peramalan-Pertumbuhan-Jumlah-UMKM-di-Kabupaten-Bangkalan.git",
    main_image: "Image/Peramalan/home.png", 

    features: [
      {
        title: "1. Login",
        desc: "The login page is used to access the system.",
        img: "Image/Peramalan/login.png",
      },
      {
        title: "2. Home Screen",
  ...
  },
  {
    ...
    tech_stack: ["HTML", "CSS", "JavaScript", "PHP", "MySQL"],
    github_link: "https://github.com/iqnasf/Cinema.git", 
    main_image: "Image/Cinema/home.PNG", 
    features: [
      {
        title: "1. Login",
  ...
  },
  {
    ...
    tech_stack: ["HTML", "CSS", "JavaScript", "PHP", "MySQL"],
    github_link: "https://github.com/iqnasf/Penerimaan-Siswa-Baru.git", 
    main_image: "Image/PPDB/home.PNG",
    features: [
      {
        title: "1. Login",
        desc: "The login page is used to access the system, offering two user roles for authentication: login as an admin or login as a standard user.",
  ...
  },
  {
    ...
    tech_stack: ["HTML", "CSS", "JavaScript", "PHP", "MySQL"],
    github_link: "https://github.com/iqnasf/Restoran.git", 
    main_image: "Image/Resto/home.PNG", 
    features: [
      {
        title: "1. Login",
